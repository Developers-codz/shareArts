...
export const HomeIcon = ({width,height}) =>{
    ...
    return (
        <svg width={width} height={height} style={{color:getAsideColor(theme)}}  viewBox="0 0 24 24"><path fill="currentColor" d="m12 5.69l5 4.5V18h-2v-6H9v6H7v-7.81l5-4.5M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3z"></path></svg>
    )
}
...
export const ProfileIcon = ({width,height}) =>{
    const {theme} = useTheme();
    return (
        <svg width={width} height={height} style={{color:getAsideColor(theme)}}  viewBox="0 0 24 24"><path fill="currentColor" d="M20 22h-2v-2a3 3 0 0 0-3-3H9a3 3 0 0 0-3 3v2H4v-2a5 5 0 0 1 5-5h6a5 5 0 0 1 5 5v2zm-8-9a6 6 0 1 1 0-12a6 6 0 0 1 0 12zm0-2a4 4 0 1 0 0-8a4 4 0 0 0 0 8z"></path></svg>
    )
}
